	...
	while (s<end) {
		if (*s=='\\') {
			...
			switch(*s) {
				case 'n':
					*t++ = '\n';
					Z_STRSETLEN_P(zendlval, Z_STRLEN_P(zendlval) - 1);
					break;
				case 'r':
					*t++ = '\r';
					Z_STRSETLEN_P(zendlval, Z_STRLEN_P(zendlval) - 1);
				...
				case 'X':
					if (ZEND_IS_HEX(*(s+1))) {
						...
						Z_STRSETLEN_P(zendlval, Z_STRLEN_P(zendlval) - 1); /* for the 'x' */
				...
				case 'u':
					{
						...
						Z_STRSETLEN_P(zendlval, Z_STRLEN_P(zendlval) - 2); /* \u */
						Z_STRSETLEN_P(zendlval, Z_STRLEN_P(zendlval) - (len - byte_len));
					}
					break;
				default:
					/* check for an octal */
